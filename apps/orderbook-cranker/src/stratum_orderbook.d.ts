...
export type StratumOrderbook = {
  ...
  "instructions": [
    ...
    {
      "name": "initializeCrankerRegistry",
      "docs": [
      ...
      "accounts": [
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "cranker_registry.order_book",
                "account": "crankerRegistry"
              }
            ]
          }
        },
    ...
    {
      "name": "submitEpochRootDecentralized",
      "docs": [
