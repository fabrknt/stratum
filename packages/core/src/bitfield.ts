/**
 * Constants matching Solana implementation defaults.
 * EVM uses different chunking (mapping-based), but these
 * are useful for off-chain simulation and Solana SDK.
 */
 ...
 * Chain-agnostic — works for both Solana and EVM off-chain use.
 */
export class Bitfield {
  ...
  /**
   * Get as number array (for Anchor/ABI encoding)
   */
  toArray(): number[] {
